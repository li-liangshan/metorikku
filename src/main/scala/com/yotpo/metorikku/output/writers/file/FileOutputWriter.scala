            ...
            case Some(tableName) => {
                ...
                path match {
                    case Some(filePath) => {
                        ...
                        writer.save()
                        protectFromEmptyOutput(dataFrame.sparkSession, fileOutputProperties.protectFromEmptyOutput,
                            fileOutputProperties.format, filePath, tableName)
